        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <p>
                    <span class="label label-danger">年龄偏低</span>
                    <span class="label label-success">系统审核通过,建议放款</span>
                    <span class="label label-info">年龄偏高</span>
                    <span class="label label-warning">敏感地域</span>
                    <span class="label label-primary">学历偏低</span>
                    </p>
